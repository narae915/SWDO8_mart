...
CREATE TABLE USER_TABLE(
    ...
    POSTCODE     NUMBER(5) DEFAULT 0,
    USER_ADDRESS VARCHAR2(100),
    ENABLED CHAR(1) DEFAULT 1 NOT NULL, -- security 권한주기용
    AUTHORITY VARCHAR2(20) DEFAULT 'ROLE_USER' NOT NULL -- security에서 회원 권한임을 알림
);
...
CREATE TABLE ITEM_TABLE(
    ...
    ITEM_AMOUNT     NUMBER(3)       DEFAULT 1, -- 상품 1개이상 등록하게 설정
    INFOR     		VARCHAR2(3999),
    COOK     		VARCHAR2(3999),
    INVENTORY 		VARCHAR2(3999),
    INTRODUCE 		VARCHAR2(3999),
    SALEFLAG		NUMBER(1) 		DEFAULT 0, -- 세일 상품인지 아닌지 판별
    SALE_PERCENT	NUMBER(3)		DEFAULT 0  -- 할인율 설정(100%까지 수용하기위해 3까지로)
);
...
CREATE TABLE RECIPE_TABLE(
    ...
    CONTENT           VARCHAR2(3999) NOT NULL,
    READ_COUNT        NUMBER         DEFAULT 0,
    SCORE             NUMBER(2,1)    DEFAULT 0, -- 소수점 첫째자리까지
    INDATE            DATE           DEFAULT SYSDATE,
    RECIPETAG         VARCHAR2(1500)
);
...
CREATE TABLE EMP_TABLE(
    ...
    AUTHORITY VARCHAR2(20) DEFAULT 'ROLE_EMP' NOT NULL
);
...
CREATE SEQUENCE EMP_NUM_SEQ
   START WITH 1111; -- 사원은 4자리부터
CREATE SEQUENCE CATEGORY_NUM_SEQ
    INCREMENT BY 10
    START WITH 10; -- 카테고리는 10단위로
...
-- ITEM_TABLE (상품 정보)
INSERT INTO ITEM_TABLE(ITEM_NUM,CATEGORY_NUM,ITEM_NAME,PRICE,ITEM_AMOUNT) VALUES (
ITEM_NUM_SEQ.NEXTVAL,10,'소고기 500G',10000,100);
INSERT INTO ITEM_TABLE(ITEM_NUM,CATEGORY_NUM,ITEM_NAME,PRICE,ITEM_AMOUNT) VALUES (
ITEM_NUM_SEQ.NEXTVAL,10,'목심(불고기용) 2.5KG',40000,50);
INSERT INTO ITEM_TABLE(ITEM_NUM,CATEGORY_NUM,ITEM_NAME,PRICE,ITEM_AMOUNT) VALUES (
ITEM_NUM_SEQ.NEXTVAL,10,'LA갈비 2.5KG',98000,70);
INSERT INTO ITEM_TABLE(ITEM_NUM,CATEGORY_NUM,ITEM_NAME,PRICE,ITEM_AMOUNT) VALUES (
ITEM_NUM_SEQ.NEXTVAL,10,'한우 사골(절단/곰탕용) 3KG',20000,100);
INSERT INTO ITEM_TABLE(ITEM_NUM,CATEGORY_NUM,ITEM_NAME,PRICE,ITEM_AMOUNT) VALUES (
ITEM_NUM_SEQ.NEXTVAL,10,'소고기 부채살 스테이크 400G',21900,80);
INSERT INTO ITEM_TABLE(ITEM_NUM,CATEGORY_NUM,ITEM_NAME,PRICE,ITEM_AMOUNT) VALUES (
ITEM_NUM_SEQ.NEXTVAL,10,'로즈마리 시즈닝 스테이크 245G',15000,100);
INSERT INTO ITEM_TABLE(ITEM_NUM,CATEGORY_NUM,ITEM_NAME,PRICE,ITEM_AMOUNT) VALUES (
ITEM_NUM_SEQ.NEXTVAL,10,'생삼겹살 300G',10600,70);
INSERT INTO ITEM_TABLE(ITEM_NUM,CATEGORY_NUM,ITEM_NAME,PRICE,ITEM_AMOUNT) VALUES (
ITEM_NUM_SEQ.NEXTVAL,10,'목전지(제육볶음용) 1KG',10000,50);
INSERT INTO ITEM_TABLE(ITEM_NUM,CATEGORY_NUM,ITEM_NAME,PRICE,ITEM_AMOUNT) VALUES (
ITEM_NUM_SEQ.NEXTVAL,10,'닭(닭볶음탕) 900G',6900,70);
INSERT INTO ITEM_TABLE(ITEM_NUM,CATEGORY_NUM,ITEM_NAME,PRICE,ITEM_AMOUNT) VALUES (
ITEM_NUM_SEQ.NEXTVAL,10,'닭가슴살 훈제 110G',2300,70);

INSERT INTO ITEM_TABLE(ITEM_NUM,CATEGORY_NUM,ITEM_NAME,PRICE,ITEM_AMOUNT) VALUES (
ITEM_NUM_SEQ.NEXTVAL,20,'급냉 새우 1KG (25~35미 내외)',24900,70);
INSERT INTO ITEM_TABLE(ITEM_NUM,CATEGORY_NUM,ITEM_NAME,PRICE,ITEM_AMOUNT) VALUES (
ITEM_NUM_SEQ.NEXTVAL,20,'해감 바지락 1KG',7900,70);
INSERT INTO ITEM_TABLE(ITEM_NUM,CATEGORY_NUM,ITEM_NAME,PRICE,ITEM_AMOUNT) VALUES (
ITEM_NUM_SEQ.NEXTVAL,20,'갈고등어 순살 120G 10팩',17500,50);
INSERT INTO ITEM_TABLE(ITEM_NUM,CATEGORY_NUM,ITEM_NAME,PRICE,ITEM_AMOUNT) VALUES (
ITEM_NUM_SEQ.NEXTVAL,20,'노르웨이산 연어 200G',16900,50);
INSERT INTO ITEM_TABLE(ITEM_NUM,CATEGORY_NUM,ITEM_NAME,PRICE,ITEM_AMOUNT) VALUES (
ITEM_NUM_SEQ.NEXTVAL,20,'국물 멸치 1.5KG',8500,50);

INSERT INTO ITEM_TABLE(ITEM_NUM,CATEGORY_NUM,ITEM_NAME,PRICE,ITEM_AMOUNT) VALUES (
ITEM_NUM_SEQ.NEXTVAL,30,'바나나 특대 1손',6980,70);
INSERT INTO ITEM_TABLE(ITEM_NUM,CATEGORY_NUM,ITEM_NAME,PRICE,ITEM_AMOUNT) VALUES (
ITEM_NUM_SEQ.NEXTVAL,30,'블랙 사파이어포도 1KG(1KG)',15000,100);
INSERT INTO ITEM_TABLE(ITEM_NUM,CATEGORY_NUM,ITEM_NAME,PRICE,ITEM_AMOUNT) VALUES (
ITEM_NUM_SEQ.NEXTVAL,30,'참외 2KG',10900,100);
INSERT INTO ITEM_TABLE(ITEM_NUM,CATEGORY_NUM,ITEM_NAME,PRICE,ITEM_AMOUNT) VALUES (
ITEM_NUM_SEQ.NEXTVAL,30,'고당도 포도(2KG)',10000,60);
INSERT INTO ITEM_TABLE(ITEM_NUM,CATEGORY_NUM,ITEM_NAME,PRICE,ITEM_AMOUNT) VALUES (
ITEM_NUM_SEQ.NEXTVAL,30,'고당도 오렌지 15개',12000,60);

INSERT INTO ITEM_TABLE(ITEM_NUM,CATEGORY_NUM,ITEM_NAME,PRICE,ITEM_AMOUNT) VALUES (
ITEM_NUM_SEQ.NEXTVAL,40,'양배추 1통',3000,50);
INSERT INTO ITEM_TABLE(ITEM_NUM,CATEGORY_NUM,ITEM_NAME,PRICE,ITEM_AMOUNT) VALUES (
ITEM_NUM_SEQ.NEXTVAL,40,'깐양파 1KG',4500,70);
INSERT INTO ITEM_TABLE(ITEM_NUM,CATEGORY_NUM,ITEM_NAME,PRICE,ITEM_AMOUNT) VALUES (
ITEM_NUM_SEQ.NEXTVAL,40,'깐대파 200G',2000,70);
INSERT INTO ITEM_TABLE(ITEM_NUM,CATEGORY_NUM,ITEM_NAME,PRICE,ITEM_AMOUNT) VALUES (
ITEM_NUM_SEQ.NEXTVAL,40,'당근 1봉지',2500,70);

INSERT INTO ITEM_TABLE(ITEM_NUM,CATEGORY_NUM,ITEM_NAME,PRICE,ITEM_AMOUNT) VALUES (
ITEM_NUM_SEQ.NEXTVAL,50,'후추 100G',5400,100);
INSERT INTO ITEM_TABLE(ITEM_NUM,CATEGORY_NUM,ITEM_NAME,PRICE,ITEM_AMOUNT) VALUES (
ITEM_NUM_SEQ.NEXTVAL,50,'소금 50G',5250,100);
INSERT INTO ITEM_TABLE(ITEM_NUM,CATEGORY_NUM,ITEM_NAME,PRICE,ITEM_AMOUNT) VALUES (
ITEM_NUM_SEQ.NEXTVAL,70,'쌀 20KG',47800,30);
