			...
			<div class="row">
				<div class="col-lg-12">
					<div class="breadcrumb-text">
						...
						<span>
							<spring:message code="message.signUp.title" />
						</span>
					</div>
				</div>
			</div>
				...
				<div class="col-lg-6 offset-lg-3">
					<div class="register-form">
						...
						<form action="/user/signUp" method="post" onsubmit="return formChk();">
							...
							<div class="group-input">
								<label for="con-pass">
									<spring:message code="message.signUp.form.pwChk" /> <span>*</span>
								</label> 
							...
							<div class="group-input">
								<label>
									<spring:message code="message.signUp.form.call" /> <span>*</span>
								</label> 
						...
						<div class="switch-login">
							<a href="/user/login" class="or-login">
